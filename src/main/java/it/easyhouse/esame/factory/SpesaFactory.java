...
public class SpesaFactory {
	...
	public static Spesa crea(String id, String tipo, double importo, LocalDate dataScadenza, String note, int numInquilini) {
        if (tipo.equals("Affitto")) {
            return new Affitto(id, importo, dataScadenza, note);
        } else {
